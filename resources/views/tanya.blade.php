...
@section('container')
    <div class="mx-auto my-3 w-11/12 flex md:justify-evenly">
        ...
        <div class="w-4/12 mx-1">
            <div class="bg-red-400 rounded-md p-3">
                <div>
                    <h2 class="font-mono font-bold">Cari kendala...</h2>
                    <input type="text" class="rounded-md" placeholder="Search...">
                </div>
            </div>
            <div class="flex justify-evenly">
                <a href="" class="m-2 w-5/12 text-center hover:bg-zinc-800 rounded-md py-1 px-3 bg-red-600 text-white">Tanya</a>
                <a href="" class="m-2 w-5/12 rounded-md text-center py-1 px-3 text-white bg-red-600 hover:bg-red-800">Cari Teknisi</a>
            </div>
        </div>
    </div>
