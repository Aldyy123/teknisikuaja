<div class="min-h-screen bg-gray-100 py-10 px-5 xl:py-0 xl:px-0 mb-6">
  <div class="min-h-screen xl:grid place-items-center place-content-center xl:grid-cols-2 xl:max-w-screen-xl mx-auto w-11/12 xl:max-w-screen-2xl gap-14">
    <div class="max-w-xl mx-auto xl:max-w-2xl xl:-mt-8">
      ...
      <p class="xl:leading-9 text-gray-900 xl:text-lg mt-3 mb-10">Kamu bisa mencari teknisi terdekat dari Daerah kamu, untuk menyelesaikan masalah elektronik yang kamu alami.</p>
      ...
      <form>   
        ...
        <input type="search" id="default-search" class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500" placeholder="Masukan Lokasi Anda" required>
        <button type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2">Search</button>
        </div>
      </form>
    ...
    <div class="card__grid mt-14 xl:mt-0 sm:justify-items-center">
      ...
      <div class="card--1 max-w-xs bg-white shadow-xl rounded-3xl pt-4 pb-8 px-5 lg:row-start-1 lg:row-end-3">
        ...
        <div>
          ...
          <p class="text-gray-400 text-sm flex justify-between items-center">Ahli Elektronika <span class="flex items-center"><svg class="w-5 h-5 mr-1 text-yellow-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="card--3 max-w-xs bg-white shadow-xl rounded-3xl pt-4 pb-8 px-5 lg:row-start-2 lg:row-end-5">
        ...
        <div>
          ...
          <p class="text-gray-400 flex justify-between items-center text-sm">Ahli Jaringan<span class="flex items-center"><svg class="w-5 h-5 mr-1 text-yellow-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
              </svg>5.0</span></p>
        </div>
